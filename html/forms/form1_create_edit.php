        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <form action="../../php/<?php echo $id_formulario ? 'update_form1.php' : 'send_form1.php'; ?>" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="solicitante" name="solicitante"
                                        value="<?php echo htmlspecialchars($name) . ' ' . htmlspecialchars($last_name). ' ' . htmlspecialchars($site); ?>"
                                        readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="estatus" name="estatus"
                                        value="<?php echo $id_formulario ? htmlspecialchars($form_data['status_form1']) : 'En Proceso'; ?>" readonly>
                                </div>
                            </div>
                            <!-- folio -->
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    value="<?php echo $id_formulario ? htmlspecialchars($form_data['id_form1']): ''; ?>" readonly>
                                </div>
                            </div>
                            <!-- Número de RFQ -->
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="numero_rfq" name="numero_rfq"
                                        value="<?php echo $id_formulario ? htmlspecialchars($form_data['rfq_number']): ''; ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="formato_entrega" name="formato_entrega" required>
                                        <option value="Rollo/Bobina" <?php echo ($id_formulario && $form_data['delivery_format'] == 'Rollo/Bobina') ? 'selected' : ''; ?>>Rollo/Bobina</option>
                                        <option value="Sachet" <?php echo ($id_formulario && $form_data['delivery_format'] == 'Sachet') ? 'selected' : ''; ?>>Sachet</option>
                                        <option value="Bolsa Preformada" <?php echo ($id_formulario && $form_data['delivery_format'] == 'Bolsa Preformada') ? 'selected' : ''; ?>>Bolsa Preformada</option>
                                        <option value="Tubular" <?php echo ($id_formulario && $form_data['delivery_format'] == 'Tubular') ? 'selected' : ''; ?>>Tubular</option>
                                    </select>
                                </div>
                            </div>
                            <!-- Formato de Empaque -->
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="formato_empaque" name="formato_empaque" required>
                                        <option value="Doypack" <?php echo ($id_formulario && $form_data['packaging_format'] == 'Doypack') ? 'selected' : ''; ?>>Doypack</option>
                                        <option value="Pillow" <?php echo ($id_formulario && $form_data['packaging_format'] == 'Pillow') ? 'selected' : ''; ?>>Pillow</option>
                                        <option value="Envolvedora" <?php echo ($id_formulario && $form_data['packaging_format'] == 'Envolvedora') ? 'selected' : ''; ?>>Envolvedora</option>
                                        <option value="ColdSeal" <?php echo ($id_formulario && $form_data['packaging_format'] == 'ColdSeal') ? 'selected' : ''; ?>>ColdSeal</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="elemento_conveniencia" name="elemento_conveniencia" required>
                                        <option value="Válvula" <?php echo ($id_formulario && $form_data['convenience_element_of_packaging'] == 'Válvula') ? 'selected' : ''; ?>>Válvula</option>
                                        <option value="Zipper" <?php echo ($id_formulario && $form_data['convenience_element_of_packaging'] == 'Zipper') ? 'selected' : ''; ?>>Zipper</option>
                                        <option value="Easy Open" <?php echo ($id_formulario && $form_data['convenience_element_of_packaging'] == 'Easy Open') ? 'selected' : ''; ?>>Easy Open</option>
                                        <option value="Corte Laser" <?php echo ($id_formulario && $form_data['convenience_element_of_packaging'] == 'Corte Laser') ? 'selected' : ''; ?>>Corte Laser</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="proceso_llenado" name="proceso_llenado" required>
                                        <option value="UHT" <?php echo ($id_formulario && $form_data['filling_process'] == 'UHT') ? 'selected' : ''; ?>>UHT</option>
                                        <option value="Pasteurizado" <?php echo ($id_formulario && $form_data['filling_process'] == 'Pasteurizado') ? 'selected' : ''; ?>>Pasteurizado</option>
                                        <option value="Flow pack" <?php echo ($id_formulario && $form_data['filling_process'] == 'Flow pack') ? 'selected' : ''; ?>>Flow pack</option>
                                        <option value="Choque Térmico" <?php echo ($id_formulario && $form_data['filling_process'] == 'Choque Térmico') ? 'selected' : ''; ?>>Choque Térmico</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="sistema_empaque" name="sistema_empaque" required>
                                        <option value="Cuello Formador" <?php echo ($id_formulario && $form_data['packaging_system'] == 'Cuello Formador') ? 'selected' : ''; ?>>Cuello Formador</option>
                                        <option value="Horizontal de Sachet" <?php echo ($id_formulario && $form_data['packaging_system'] == 'Horizontal de Sachet') ? 'selected' : ''; ?>>Horizontal de Sachet</option>
                                        <option value="Vertical Sachet" <?php echo ($id_formulario && $form_data['packaging_system'] == 'Vertical Sachet') ? 'selected' : ''; ?>>Vertical Sachet</option>
                                        <option value="Doypack" <?php echo ($id_formulario && $form_data['packaging_system'] == 'Doypack') ? 'selected' : ''; ?>>Doypack</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="unidad_venta" name="unidad_venta" required>
                                        <option value="Unidades" <?php echo ($id_formulario && $form_data['sales_unit'] == 'Unidades') ? 'selected' : ''; ?>>Unidades</option>
                                        <option value="Kilogramos (KG)" <?php echo ($id_formulario && $form_data['sales_unit'] == 'Kilogramos (KG)') ? 'selected' : ''; ?>>Kilogramos (KG)</option>
                                        <option value="Metros" <?php echo ($id_formulario && $form_data['sales_unit'] == 'Metros') ? 'selected' : ''; ?>>Metros</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="volumen_pedido" name="volumen_pedido"
                                        value="<?php echo $id_formulario ? htmlspecialchars($form_data['volume_per_order']) : ''; ?>" required />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="volumen_anual" name="volumen_anual"
                                        value="<?php echo $id_formulario ? htmlspecialchars($form_data['annual_volume']) : ''; ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="sistema_impresion" name="sistema_impresion" required>
                                        <option value="Rotograbado" <?php echo ($id_formulario && $form_data['printing_system'] == 'Rotograbado') ? 'selected' : ''; ?>>Rotograbado</option>
                                        <option value="Flexografía" <?php echo ($id_formulario && $form_data['printing_system'] == 'Flexografía') ? 'selected' : ''; ?>>Flexografía</option>
                                        <option value="Sin impresión" <?php echo ($id_formulario && $form_data['printing_system'] == 'Sin impresión') ? 'selected' : ''; ?>>Sin impresión</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="numero_colores" name="numero_colores"
                                        value="<?php echo $id_formulario ? htmlspecialchars($form_data['number_of_colors']) : ''; ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="ancho" name="ancho"
                                        value="<?php echo $id_formulario ? htmlspecialchars($form_data['width_mm']) : ''; ?>" step="any" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="tolerancia_ancho" name="tolerancia_ancho"
                                        value="<?php echo $id_formulario ? htmlspecialchars($form_data['width_tolerance_mm']) : ''; ?>" step="any" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" id="check_diseno_continuo" name="check_diseno_continuo"
                                        onchange="toggleFotodistancias()" <?php echo ($id_formulario && $form_data['continuous_design_check'] == 1) ? 'checked' : ''; ?>>
                            ...
                            <div class="col-md-5">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="fotodistancias" name="fotodistancias"
                                        value="<?php echo $id_formulario ? htmlspecialchars($form_data['photo_distances_mm']) : ''; ?>" step="any">
                                </div>
                            </div>
                            ...
                            <div class="col-md-5">
                                <div class="mb-3">
                                    <label for="tolerancia_fotodistancias" class="form-label">Tolerancia Fotodistancias (mm)</label>
                                    <input type="number" class="form-control" id="tolerancia_fotodistancias" name="tolerancia_fotodistancias"
                                        value="<?php echo $id_formulario ? htmlspecialchars($form_data['photo_distances_tolerance_mm']) : ''; ?>" step="any">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="calibre" name="calibre"
                                        value="<?php echo $id_formulario ? htmlspecialchars($form_data['thickness_microns']) : ''; ?>" step="any" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="tolerancia_calibre" name="tolerancia_calibre"
                                        value="<?php echo $id_formulario ? htmlspecialchars($form_data['thickness_tolerance_microns']) : ''; ?>" step="any" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="peso" name="peso"
                                        value="<?php echo $id_formulario ? htmlspecialchars($form_data['weight_gm2']) : ''; ?>" step="any" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="tolerancia_peso" name="tolerancia_peso"
                                        value="<?php echo $id_formulario ? htmlspecialchars($form_data['weight_tolerance_gm2']) : ''; ?>" step="any" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 bolsa_fields">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="largo" name="largo"
                                        value="<?php echo $id_formulario ? htmlspecialchars($form_data['length_mm']) : ''; ?>" step="any">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 bolsa_fields">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="fuelle" name="fuelle"
                                        value="<?php echo $id_formulario ? htmlspecialchars($form_data['gusset_mm']): ''; ?>" step="any">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 bolsa_fields">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="traslape" name="traslape"
                                        value="<?php echo $id_formulario ? htmlspecialchars($form_data['overlap_mm']): ''; ?>" step="any">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" id="check_sostenibilidad" name="check_sostenibilidad"
                                        onchange="toggleCodigoSostenibilidad()" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="codigo_sostenibilidad" name="codigo_sostenibilidad"
                           ...
                           <!-- Ficha Técnica -->
                            ...
                            <div class="col-md-12">
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary"><?php echo $id_formulario ? 'Actualizar' : 'Crear'; ?> Cotización</button>
                                </div>
                            </div>
