...
$sql = "SELECT id, id_form4, id_user, name_user, name_client, status_form4, project_name, qualified_by, created_at, completed_at FROM form4";
...
<body id="page-top">
                    ...
                    <table class="table table-striped mt-4">
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<tr>";
                                echo "<td>" . $row['id_form4'] . "</td>"; // Usando el ID aquí
                                ...
                                echo "<td>
                                        <a href='/r&d/html/forms/form4_show.php?id=" . $row['id'] . "' class='btn btn-outline-primary btn-sm'>Ver completo</a>";

                                // Mostrar el botón de "Calificar" solo si el estado no es "Complete"
                                if ($row['status_form4'] !== 'Complete') {
    ...
    function submitCalificacion(opcion, id) {
        const url = (opcion === 'Rechazar') ? '../../php/rechazar_form4.php' : '../../php/aprobar_form4.php';
