...
$sql = "SELECT id, id_form3, id_user, name_user, name_client, status_form3, project_name 
        FROM form3
                    ...
                    <table class="table table-striped mt-4">
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td><a href='/r&d/html/forms/form3_show.php?id=" . $row['id'] . "' class='btn btn-outline-primary btn-sm'>Ver completo</a> ";
